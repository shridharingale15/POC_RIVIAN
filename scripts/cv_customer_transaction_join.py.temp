...
# dynamicdf=DynamicFrame.fromDF(ApplyMapping_node3_no_nulls, glueContext, "dynamicdf")
    ...
    client = boto3.client('stepfunctions')
    response = client.start_execution(stateMachineArn='arn:aws:states:us-east-1:622527851988:stateMachine:cv_MyStateMachine_POC',name='cv_MyStateMachine_POC_dyanamic_batch_test_4')
